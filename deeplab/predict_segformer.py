...
def predict(img,
    ...
    with torch.no_grad():
        ...
        size=(256,256),
        mode="bilinear",
        align_corners=False,)  # send through model/network
...
model_name = 'segformer_50_epochs_adam_actual_ftl.pt'
...
plot_comparison(ground_truths_to_plot, predictions_to_plot, save_path='ground_truth_vs_predictions_segformer.png')
